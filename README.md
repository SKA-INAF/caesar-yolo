...
*IMAGE PRE-PROCESSING*     
  ...
  `--sigma_clip_low=[VALUE]`: Lower sigma threshold to be used for clipping pixels below (mean-sigma_low*stddev). Default: 10.0   
  `--sigma_clip_up=[VALUE]`: Upper sigma threshold to be used for clipping pixels above (mean+sigma_up*stddev). Default: 10.0     
  ...
  `--sigma_clip_baseline=[VALUE]`: Lower sigma threshold to be used for clipping pixels below (mean-sigma_low*stddev) in first channel of 3-channel preprocessing. Default: 0.0         
