...
def parse_args():
	...
	parser.add_argument('--zscale_contrasts', dest='zscale_contrasts', required=False, type=str, default='0.25;0.25;0.25', help='zscale contrasts applied to all channels, separated by semicommas') 
	...
	# - RUN OPTIONS
	parser.add_argument('--devices', required=False, type=str, default="cpu", metavar="Specifies the device for inference (e.g., cpu, cuda:0).", help="Specifies the device for inference (e.g., cpu, cuda:0 or 0). Separated by semicommas")
